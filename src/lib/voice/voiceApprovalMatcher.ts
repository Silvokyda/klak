export type VoiceApprovalMatch = "approve" | "deny" | "ambiguous" | "sleep" | "none";
...
export function matchVoiceApprovalTranscript(transcript: string): VoiceApprovalMatch {
...
export function isDeterministicSleepCommand(transcript: string): boolean {
